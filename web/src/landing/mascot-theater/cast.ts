...
export const CAST: CastEntry[] = [
  // Top row (4)
  {
    id: "dino-kigurumi",
    eyebrow: "#042 · Dino",
    headline: "Prehistoric run",
    body: "Snappy gone prehistoric. Life, uh, finds a way to launch.",
    rot: -3,
  },
  {
    id: "cape-and-fangs",
    ...
    body: "Centuries of thirst. I vant to launch your applications.",
    rot: -2,
  },
  {
    id: "time-wanderer-striped-scarf-2",
    eyebrow: "#091 · Wanderer",
    headline: "Loop edition",
    body: "Snappy as an ever-changing time traveller. Four pockets, all full of jelly babies and launch configs.",
    rot: 4,
  },
  {
    id: "relic-hunter-idol",
    eyebrow: "#077 · Adventurer",
    headline: "Field expedition",
    body: "Swapping the idol for a sandbag. It belongs in the app catalogue.",
    rot: -5,
  },
  // Bottom row (3)
  {
    id: "banana-goggle-minion",
    eyebrow: "#055 · Banana",
    headline: "Peel & launch",
    body: "Snappy armed with a banana. LAUNCH! BA-NA-NA!",
    rot: -4,
  },
  {
    id: "striped-sweater-fedora",
    eyebrow: "#031 · Slasher",
    headline: "Dream slayer",
    body: "Haunting your dreams. It knows what apps you want to launch next.",
    rot: 2,
  },
  {
    id: "werewolf",
    eyebrow: "#???",
    headline: "Lunar edition",
    body: "Hear that howl? Something hairy this way comes.",
    rot: 5,
    silhouette: true,
  },
];
