...
// ─── Shared header/footer chrome (lifted from V1ClassicHero so this
// file stands alone in the V1b-only standalone export). ───
const navLinkStyle = {
...
const SnappyWordmark = ({ size = 18 }) => (
  <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
    <img
      src={(window.__resources && window.__resources["mascot-original"]) || "assets/mascots/snappy-original-384.webp"}
      alt="Snappy"
